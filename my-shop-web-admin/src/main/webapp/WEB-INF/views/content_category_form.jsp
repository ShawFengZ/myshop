                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input id="parentName" class="form-control required" placeholder="请选择父级类目" readonly="true" data-toggle="modal" data-target = "#modal-default" value="${tbContentCategory.parent.name}" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input cssClass="form-control required" path="sortOrder" placeholder="分类名称"/>
                                    </div>
                                </div>
